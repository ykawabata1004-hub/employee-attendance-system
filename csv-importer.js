    ...
    importConcurCSV(csvText, scope = 'all', scopeValue = null) {
        try {
            ...
            const mapping = {
                ...
                location: headers.findIndex(h => h === 'Branch' || h === 'Location'),
            ...
            dataLines.forEach((line, index) => {
                ...
                try {
                    ...
                    if (!employee) {
                        ...
                        console.log(`Auto-created employee: ${employeeName} (${employeeId})`);
                    }
            ...
            return {
                ...
                autoCreated: dataLines.length - errors.length - imported.length === 0 ? 0 : 'check logs', // simplified
                errors: errors
            };
        } catch (error) {
            return {
